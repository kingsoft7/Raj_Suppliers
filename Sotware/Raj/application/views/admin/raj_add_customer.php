...
<div class="container">
  <?php echo form_open('raj_customer_controller/saveData',['class'=>'form-horizontal']); ?>
    <?php echo form_hidden('cusBalance',0); ?>
  <fieldset>
...
<div class="col-xs-8">
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" name="cusName" class="form-control" id="inputEmail" placeholder="Name">
      </div>
...
<div class="col-xs-8">
   <div class="form-group">
      <label for="textArea" class="col-lg-2 control-label">cusAddress</label>
      <div class="col-lg-10">
        <textarea class="form-control" rows="3" id="textArea" placeholder="Address" name="cusAddress"></textarea>
        </div>
    </div>
</div>
...
<div class="col-xs-8">
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" class="form-control" name="cusPhoneNo" id="inputEmail" placeholder="Phone Number">
      </div>
    </div>
</div>
...
<div class="col-xs-8">
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" class="form-control" name="cusPanNo" id="inputEmail" placeholder="PAN Number">
      </div>
    </div>
</div>
...
<div class="col-xs-8">
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" class="form-control" name="cusMName" id="inputEmail" placeholder="Manager Name">
      </div>
    </div>
</div>
...
<div class="col-xs-8">
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <input type="text" class="form-control" name="cusMPhoneNo" id="inputEmail" placeholder="Phone Number">
      </div>
    </div>
</div>
