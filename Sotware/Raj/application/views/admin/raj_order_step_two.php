...
<div class="container">
  <?php echo form_open('raj_order_controller/saveTempData',['class'=>'form-horizontal']); ?>
  <?php
$item_id=$arr['item_id'];
$items=$arr['subItem'];
//echo "<pre>";
...
<div class="col-xs-8">
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <select class="form-control" id="select" name="subItem_id" value="<?php echo set_value('subItem_id'); ?>" required>
           <?php
...
<div class="col-xs-8">
    <div class="form-group">
      <label for="inputEmail" class="col-lg-2 control-label">Rate(Per Unit)</label>
      <div class="col-lg-10">
        <input type="text" name="item_price" class="form-control" id="inputEmail" placeholder="Amount">
      </div>

    </div>
</div>
<div class="col-xs-4"><?php echo form_error('item_price'); ?></div>
